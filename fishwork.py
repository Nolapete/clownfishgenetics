...
def pheno(genotype, parent1, parent2):
    ...
    if parent1.find("ocellaris") != -1 and parent2.find("ocellaris") != -1:
        ...
        and parents.find('Premnas sp. epigrammata "Goldflake / Gold Spot / Gold Rush"')
        != -1
    ):
        if g1 == "G/+":
        ...
        # " (", parent1[spP1part2 + 1:], " X ", parent2[spP2part2 + 1:], ") TEST1")
...
a1 = (Animal.objects.values_list(
    'phenotype',
    'locus__gene',
    'locus__allele1',
    'locus__allele2'
    )
    .filter(phenotype='Amphiprion ocellaris "Frostbite"')
)
